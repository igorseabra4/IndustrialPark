...
namespace IndustrialPark.Randomizer
{
    public class RandomizableArchive : ArchiveEditorFunctions
    {
        public bool Randomize(int seed, RandomizerSettings settings, Random gateRandom, out bool needToAddNumbers)
        {
            ...
            //                        surf.zSurfUVFX.TransSpeed_X = localRandom.NextFloat(settings.surfMin, settings.surfMax);
            //                    else
            //                        surf.zSurfUVFX.TransSpeed_X *= localRandom.NextFloat(settings.surfMin, settings.surfMax);

            //                    if (surf.zSurfUVFX.TransSpeed_Y == 0)
            //                        surf.zSurfUVFX.TransSpeed_Y = localRandom.NextFloat(settings.surfMin, settings.surfMax);
            //                    else
            //                        surf.zSurfUVFX.TransSpeed_Y *= localRandom.NextFloat(settings.surfMin, settings.surfMax);
            ...
            //        private bool ShuffleVilTypes(int seed, List<VilType_BFBB> chooseFrom, List<VilType_BFBB> setTo, bool mixModels, bool veryRandom, bool enemies)
            //        {
            //            Random r = new Random(seed);
            ...
            //                {
            //                    VilType_BFBB randomRemove = setTo[r.Next(0, setTo.Count)];
            ...
            //            List<VilType_BFBB> viltypes = (from asset in assets select asset.VilType).ToList();
            //            List<AssetID> models = (from asset in assets select asset.Model_AssetID).ToList();

            //            foreach (AssetVIL a in assets)
            //            {
            //                VilType_BFBB prevVilType = a.VilType;
            ...
            //                    a.Model_AssetID =
            //                        a.VilType == VilType_BFBB.robot_sleepytime_bind ?
            ...
            //                            (vil.VilType == VilType_BFBB.tubelet_slave_bind || vil.VilType == VilType_BFBB.robot_arf_dog_bind))
            //                        {
            ...
            //                if (a.VilType == VilType_BFBB.robot_arf_bind || a.VilType == VilType_BFBB.tubelet_bind)
            //                {
            ...
            //                        "RANDO_" + (a.VilType == VilType_BFBB.tubelet_bind ? "TUBELET" : "ARF"),
            //                       (a.VilType == VilType_BFBB.tubelet_bind ? AssetTemplate.Tubelet : AssetTemplate.Arf)));
