...
{
    public class AssetPKUP : RenderableAssetWithPosition
    {
        ...
        protected override void CreateBoundingBox()
        {
            try
            {
                boundingBox = BoundingBox.FromPoints(ArchiveEditorFunctions.renderingDictionary[AssetPICK.pick.pickEntries[_pickEntryID].unknown4].GetRenderWareModelFile().GetVertexList().ToArray());
            }
            catch
            {
