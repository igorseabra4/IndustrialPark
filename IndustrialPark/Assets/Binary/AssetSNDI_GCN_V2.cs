...
//            {
//                GcWavInfo a = new GcWavInfo();
//                a.SetEntryPartTwo(binaryReader);
//                entries[a.uFSBIndex].soundEntries[a.uAudioSampleIndex].SetEntryPartTwo(a);
//            }
...
//            foreach (GcWavInfo a in listForPart2)
...
//                    {
//                        var r = f;
//                        r.soundEntries = new GcWavInfo[] { f.soundEntries[i] };
