...
namespace IndustrialPark
{
    public class AssetPLAT : PlaceableAsset
    {
        ...
        {
            get { return ReadFloat(0x7C + Offset); }
            set { Write(0x7C + Offset, value); }
        }

        public float UnknownFloat_80
        {
            get { return ReadFloat(0x80 + Offset); }
