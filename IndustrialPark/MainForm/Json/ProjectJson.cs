...
namespace IndustrialPark
{
    public class ProjectJson
    {
        ...
        public ProjectJson(List<string> hipPaths, List<string> textureFolderPaths, Vector3 camPos, float yaw, float pitch, float speed, float speedRot, float fieldOfView, float farPlane, bool noCulling, bool wireframe, Color4 backgroundColor, Vector4 widgetColor, bool useLegacyAssetIDFormat, bool alternateNameDisplayMode, bool renderLevelModel, bool renderBOUL, bool renderBUTN, bool renderCAM, bool renderDSTR, bool renderMRKR, bool renderMVPT, bool renderPKUP, bool renderPLAT, bool renderPLYR, bool renderSIMP, bool renderTRIG, bool renderVIL)
        {
